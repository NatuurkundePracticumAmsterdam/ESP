...
In {numref}`fig:cs13`a the modulus of the amplitude transfer function is larger than 1 at a phase of 180$^{\rm o}$: the signal is amplified through the feedback and the closed system becomes unstable. \
In {numref}`fig:cs13`b the modulus of the amplitude transfer function is smaller than 1 at a phase of 180$^{\rm o}$: the signal is attenuated through the feedback and the closed system is stable.
